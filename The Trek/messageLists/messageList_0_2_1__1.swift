...
var messageList_0_2_1__1 = [
	
	//DAY 1
	
	"[RESEARCH|JACK:\nI've got a guy on line 2. Seems urgent, but everyone else is busy right now. Should I patch you through?",
	...
	"[RESPONSE|Blizzard?|1|So what\nhappened?|Oh, so as we got closer, I asked him to take me on a quick pass over the Karakoram mountain range",
	...
	"Oh, so as we got closer, I asked him to take me on a quick pass over the Karakoram mountain range", //KEY
	"At first he resisted because the wind was starting to pick up",
	"But... it's Pakistan after all. There's not much you can't do with a little cash",
	"[WAIT|1",
